...
### Unix (macOS, Linux, FreeBSD, Android, iOS)
...
Invoke-WebRequest -Uri "https://github.com/bikramtuladhar/claude-code-resumer/releases/latest/download/cs-windows-x64.exe" -OutFile "$env:LOCALAPPDATA\Microsoft\WindowsApps\cs.exe"
...
- **Cross-platform** - Windows, macOS, Linux, FreeBSD, Android (Termux), iOS (iSH)
...
Invoke-WebRequest -Uri "https://github.com/bikramtuladhar/claude-code-resumer/releases/latest/download/cs-windows-x64.exe" -OutFile "C:\Windows\cs.exe"

# ARM64 (Windows on ARM devices like Surface Pro X)
Invoke-WebRequest -Uri "https://github.com/bikramtuladhar/claude-code-resumer/releases/latest/download/cs-windows-arm64.exe" -OutFile "C:\Windows\cs.exe"
```
...
# ARM64
Invoke-WebRequest -Uri "https://github.com/bikramtuladhar/claude-code-resumer/releases/latest/download/cs-windows-arm64.exe" -OutFile "$env:LOCALAPPDATA\Microsoft\WindowsApps\cs.exe"
```
...
| `%USERPROFILE%\.cs\sessions` | Session database on Windows |
...
|----------|--------------|-------------|
| Windows | x64 | `cs-windows-x64.exe` |
| Windows | ARM64 | `cs-windows-arm64.exe` |
