...
## [0.3.0](https://github.com/bikramtuladhar/claude-code-resumer/compare/v0.2.0...v0.3.0) (2026-01-24)


### Features

* support non-git directories with folder-only session names ([64ddac8](https://github.com/bikramtuladhar/claude-code-resumer/commit/64ddac89db64b00b1f7d2bceff09bfceb457e9aa))
