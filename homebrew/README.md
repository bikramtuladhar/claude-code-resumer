...
3. Update `YOUR_USERNAME` in the formula to your actual GitHub username
...
curl -sL https://github.com/YOUR_USERNAME/claude-code-resumer/releases/download/v1.0.0/cs-macos-arm64 | shasum -a 256
curl -sL https://github.com/YOUR_USERNAME/claude-code-resumer/releases/download/v1.0.0/cs-macos-intel | shasum -a 256
curl -sL https://github.com/YOUR_USERNAME/claude-code-resumer/releases/download/v1.0.0/cs-linux-x64 | shasum -a 256
curl -sL https://github.com/YOUR_USERNAME/claude-code-resumer/releases/download/v1.0.0/cs-linux-arm64 | shasum -a 256
```
